...
trait CsvImportTrait
{
    public function processCsvImport(Request $request)
    {
        try {
            ...
            $modelName = 'Member';//$request->input('modelName', false);
    ...
    public function parseCsvImport(Request $request)
    {
        ...
        $modelName     = 'Member';///$request->input('model', false);
        ...
        $routeName = 'admin.' . strtolower(Str::plural(Str::kebab('leads'))) . '.processCsvImport';
