                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 {{ $errors->has('box') ? 'is-invalid' : '' }}"
                                ...
                                @foreach ($boxes as $id => $entry)
                                    <option value="{{ $id }}" {{ old('box_id') == $id ? 'selected' : '' }}>
                                        {{ $entry }}</option>
                                @endforeach
                            </select>
                            @if ($errors->has('box'))
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('amount_before_vat') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('amount_before_vat', '') }}" step="0.01" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('vat') ? 'is-invalid' : '' }}" type="number"
                                name="vat" id="vat" value="{{ old('vat', '') }}" step="0.01" required>
                            @if ($errors->has('vat'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('vat') }}
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control {{ $errors->has('amount_after_vat') ? 'is-invalid' : '' }}"
                                ...
                                value="{{ old('amount_after_vat', '') }}" step="0.01" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control datetime {{ $errors->has('delivery_date') ? 'is-invalid' : '' }}"
                                ...
                                id="delivery_date" value="{{ old('delivery_date') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status"
                                ...
                                @foreach (App\Models\Order::status_SELECT as $key => $label)
                                    <option value="{{ $key }}"
                                        {{ old('status', 'created') === (string) $key ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
