        ...
        <div class="navbar-header">
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="client-dashboard" class="logo logo-dark">
                        <span class="logo-sm">
                    ...
                    <a href="client-dashboard" class="logo logo-light">
                        <span class="logo-sm">
                            <img src="<?php echo e(URL::asset('build/images/logo-sm.png')); ?>" alt="" height="22">
                        </span>
                        <span class="logo-lg">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <!-- item-->
                        <a href="<?php echo e(url('client-dashboard')); ?>" class="dropdown-item notify-item language py-2"
...
<?php /**PATH /Users/shijazi/Documents/mywork/rds/default/resources/views/layouts/topbar.blade.php ENDPATH**/ ?>