<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('global.create')); ?> <?php echo e(trans('cruds.order.title_singular')); ?>

        </div>

        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.orders.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 <?php echo e($errors->has('box') ? 'is-invalid' : ''); ?>"
                                ...
                                <?php $__currentLoopData = $boxes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>" <?php echo e(old('box_id') == $id ? 'selected' : ''); ?>>
                                        <?php echo e($entry); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2 <?php echo e($errors->has('driver') ? 'is-invalid' : ''); ?>"
                                ...
                                <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>" <?php echo e(old('driver_id') == $id ? 'selected' : ''); ?>>
                                        <?php echo e($entry); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('amount_before_vat') ? 'is-invalid' : ''); ?>"
                                ...
                                value="<?php echo e(old('amount_before_vat', '')); ?>" step="0.01" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('vat') ? 'is-invalid' : ''); ?>" type="number"
                                name="vat" id="vat" value="<?php echo e(old('vat', '')); ?>" step="0.01" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('discount') ? 'is-invalid' : ''); ?>" type="number"
                                name="discount" id="discount" value="<?php echo e(old('discount', '')); ?>" step="0.01">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('amount_after_vat') ? 'is-invalid' : ''); ?>"
                                ...
                                value="<?php echo e(old('amount_after_vat', '')); ?>" step="0.01" required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control datetime <?php echo e($errors->has('delivery_date') ? 'is-invalid' : ''); ?>"
                                type="text" name="delivery_date" data-provider="flatpickr" data-date-format="Y-m-d H:i:s"
                                id="delivery_date" value="<?php echo e(old('delivery_date')); ?>">
                            ...
                            <select class="form-control <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>" name="status"
                                ...
                                <?php $__currentLoopData = App\Models\Order::status_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>"
                                        <?php echo e(old('status', 'created') === (string) $key ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shijazi/Documents/mywork/rds/default/resources/views/admin/orders/create.blade.php ENDPATH**/ ?>