<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.clientAddress.title_singular')); ?>

        </div>

        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.client-addresses.update', [$clientAddress->id])); ?>"
                            ...
                            <select class="form-control select2 <?php echo e($errors->has('client') ? 'is-invalid' : ''); ?>"
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $id => $entry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($id); ?>"
                                        <?php echo e((old('client_id') ? old('client_id') : $clientAddress->client->id ?? '') == $id ? 'selected' : ''); ?>>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('lat') ? 'is-invalid' : ''); ?>" type="number"
                                name="lat" id="lat" value="<?php echo e(old('lat', $clientAddress->lat)); ?>" step="0.01"
                                required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('lng') ? 'is-invalid' : ''); ?>" type="number"
                                name="lng" id="lng" value="<?php echo e(old('lng', $clientAddress->lng)); ?>" step="0.01"
                                required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>" type="text"
                                name="name" id="name" value="<?php echo e(old('name', $clientAddress->name)); ?>" required>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shijazi/Documents/mywork/rds/default/resources/views/admin/clientAddresses/edit.blade.php ENDPATH**/ ?>