<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-header">
            <?php echo e(trans('global.edit')); ?> <?php echo e(trans('cruds.box.title_singular')); ?>

        </div>

        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.boxes.update', [$box->id])); ?>" enctype="multipart/form-data">
                            ...
                            <select class="form-control <?php echo e($errors->has('status') ? 'is-invalid' : ''); ?>" name="status"
                                ...
                                <?php $__currentLoopData = App\Models\Box::STATUS_SELECT; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($key); ?>"
                                        <?php echo e(old('status', $box->status) === (string) $key ? 'selected' : ''); ?>>
                                        <?php echo e($label); ?>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('price') ? 'is-invalid' : ''); ?>" type="number"
                                name="price" id="price" value="<?php echo e(old('price', $box->price)); ?>" step="0.01"
                                required>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('lat') ? 'is-invalid' : ''); ?>" type="number"
                                name="lat" id="lat" value="<?php echo e(old('lat', $box->lat)); ?>" step="0.01">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('lng') ? 'is-invalid' : ''); ?>" type="number"
                                name="lng" id="lng" value="<?php echo e(old('lng', $box->lng)); ?>" step="0.01">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control date <?php echo e($errors->has('expiry_date') ? 'is-invalid' : ''); ?>"
                                ...
                                value="<?php echo e(old('expiry_date', $box->expiry_date)); ?>">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('serial_number') ? 'is-invalid' : ''); ?>"
                                ...
                                value="<?php echo e(old('serial_number', $box->serial_number)); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('color') ? 'is-invalid' : ''); ?>" type="text"
                                name="color" id="color" value="<?php echo e(old('color', $box->color)); ?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control <?php echo e($errors->has('size') ? 'is-invalid' : ''); ?>" type="text"
                                name="size" id="size" value="<?php echo e(old('size', $box->size)); ?>">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/shijazi/Documents/mywork/rds/default/resources/views/admin/boxes/edit.blade.php ENDPATH**/ ?>